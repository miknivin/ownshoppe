        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-12 col-sm-12 content-column">
            <div className="content-box">
              ...
              <h2>Crafting the <span> World’s Finest Fragrances for .</span> Iconic Brands.</h2>
              <p>At JJ Perfumes, we partner with leading luxury brands to create unforgettable signature scents, blending art, science, and passion</p>
