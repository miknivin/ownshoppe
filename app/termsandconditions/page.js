                ...
                <div className="col-lg-12 col-md-12 col-sm-12 content-column">
                  <div className="content-box">
                    ...
                    >
                      ...
                      <p className="mt_30">
                        Welcome to JJ Perfumes, a website owned and operated by
                        JJ Perfumes International. By using this website, you
                        accept and agree to comply with these Terms and
                    ...
                    <div className="terms-content">
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          The content, design, and intellectual property of this
                          website are owned by JJ Perfumes International.
                          Reproduction, distribution, or any other use of the
                          materials on this website is prohibited without the
                          express written consent of JJ Perfumes International.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          information on this website, we make no
                      ...
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          Product availability on the website is subject to
                          change without notice. We do not guarantee the
                          availability of any product listed on the website.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          These links are provided for your convenience, and we
                          do not endorse the content of third-party websites.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          you provide on this website is accurate, current, and
                          complete. You agree to use this website only for
                          lawful purposes and in a manner that does not infringe
                          the rights of, or restrict or inhibit the use and
                      ...
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          All orders placed on JJ perfumes are subject to
                          acceptance. We reserve the right to refuse or cancel
                          any order for any reason, including but not limited to
                          product availability, errors in product or pricing
                      ...
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          products at any time. Payments are processed through
                          secure payment gateways. We do not store credit card
                          details.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          Shipping costs and delivery times are provided during
                          the checkout process. We are not responsible for
                          delays or issues caused by shipping carriers.
                        </p>
                      </div>
                      ...
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          information and for restricting access to your
                          account.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          JJ Perfumes International reserves the right to change
                      ...
                      <div className="terms-item mb_40">
                        ...
                        <p>
                          ...
                          construed in accordance with the laws of Kerala,
                          India, and any disputes relating to these terms and
                          conditions will be subject to the exclusive
                          jurisdiction of the courts of Kerala, India,
                          specifically the High Court of Kerala.
                        </p>
                      </div>
                      <div className="terms-item mb_40">
